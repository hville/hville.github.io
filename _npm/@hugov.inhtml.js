...
const TW = D.createTreeWalker(D, 1);
const $ = (sel, elm) => (elm || D).querySelector(sel);
const $$ = (sel, elm) => (elm || D).querySelectorAll(sel);
...
export { $, $$, $ids, TW, cast, delegate, frame, html, list };
