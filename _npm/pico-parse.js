...
/* any e0 / e1 / ... / en */
const any = ruleOfN.bind({peek: function(t,i=0) {
...
/* sequence e0 e1 ... en */
const seq = ruleOfN.bind({peek: function(t,i=0) {
	const tree = [];
	let j = i;
...
/* (e0 ... en)* */
const run = ruleOf1.bind({peek: function(t,i=0) {
...
/* (e0 ... en)? */
const opt = ruleOf1.bind({peek: function(t,i=0) {
	if (i>t.length) return this.tree(i,-1)
...
export { and, any, few, not, opt, run, seq };
